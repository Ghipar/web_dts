            ...
            <section class="content">
                ...
                <div class="row">
	               ...
	               or nama_peminjam like '%$qcari%' and status = 'kembali' ";
                                ...
                                ?>
                                <center>
                                    <h4>Jumlah Transaksi : <?php echo "$transaksi"; ?> Pcs </h4>
                                </center>

                                <div class="text-right" style="margin-top: 10px;">
                                    <a href="transaksi.php" class="btn btn-sm btn-info">Refresh Transaksi <i class="fa fa-refresh"></i></a> <a href="insert-transaksi.php" class="btn btn-sm btn-warning">Tambah Transaksi<i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
                    </div>

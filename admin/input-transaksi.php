                                ...
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-transaksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8" style="padding-top: 3px; ">
                                            <select name="cars" id="cars" style="min-height: 30px; width: 400px; padding-left: 8px;" onfocus='this.size=5;' onblur='this.size=1;' onchange='this.size=1; this.blur();'>
                                                <?php
                                                include '../conn.php';
                                                $query = mysqli_query($conn, "SELECT * from data_buku ORDER BY judul");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="tgl_pinjam" class="form-control" id="tgl_pinjam" type="date" placeholder="2023" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Tanggal Kembali</label>
                                        <div class="col-sm-8">
                                            <input name="tgl_kembali" class="form-control" id="tgl_kembali" type="date" placeholder="Joko Widodo" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    </div>
